...
function highlight_get_footer_copyright($copyright, $preview_atts)
{
    ...
    $copyrightText = __('Photography by %s', 'highlight');
    $copyrightText = sprintf($copyrightText, '<a target="_blank" href="%1$s" class="mesmerize-theme-link">Ali Curzon</a>');
    
    $copyrightText = sprintf($copyrightText, 'https://alicurzonphotography.co.uk/');
    
    $copyright = '<p ' . $preview_atts . ' class="copyright">&copy;&nbsp;' . "&nbsp;" . date_i18n(__('Y', 'highlight')) . '&nbsp;<br>' . wp_kses_post($copyrightText) . '</p>';
